...
# export WANDB_API_KEY=639bb1a7bb237f2748b85818672eb11c6dd57f61

python3 -m verl.trainer.main_ppo \
    trainer.experiment_name='r1-1.5b-base3_len_16384rollout4_join' \
    trainer.default_local_dir=save_1638newonlylenroolout4_join \
    ...
    trainer.test_freq=5 \
    trainer.total_epochs=4 $@ 2>&1 | tee grpo.log